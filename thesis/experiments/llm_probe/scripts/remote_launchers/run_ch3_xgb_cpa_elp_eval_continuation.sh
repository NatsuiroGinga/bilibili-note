...
readonly RUN_ID="${PARENT_RUN_ID}-eval-continuation1"
readonly SCREEN_NAME=ch3-xgb-target-eval-cont1
...
readonly SCRIPT_PATH="$PROJECT_ROOT/scripts/remote_launchers/run_ch3_xgb_cpa_elp_eval_continuation.sh"
