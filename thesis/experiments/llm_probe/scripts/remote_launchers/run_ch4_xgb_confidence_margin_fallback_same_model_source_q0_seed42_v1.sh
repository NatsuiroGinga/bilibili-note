...
readonly RUN_ID=ch4-xgb-confidence-margin-fallback-same-model-source-q0-seed42-v1
readonly TOOL_PATH="$PROJECT_ROOT/tools/ch4_xgb_confidence_margin_fallback_same_model_source_q0.py"
readonly CONFIG_PATH="$PROJECT_ROOT/configs/ch4-xgb-confidence-margin-fallback-same-model-source-q0-seed42-v1.json"
readonly SCRIPT_PATH="$PROJECT_ROOT/scripts/remote_launchers/run_ch4_xgb_confidence_margin_fallback_same_model_source_q0_seed42_v1.sh"
...
printf 'MECHANISM2_CONFIDENCE_MARGIN_SAME_MODEL_SOURCE_Q0_STARTED run=%s pid=%s\n' "$RUN_ROOT" "$!"
