...
config=configs/shared_b0_qwen_seed42_200_genis_batch16_v1.yaml
adapter_path=runs/baselines/shared-b0-qwen-seed42-200/checkpoint-200
test_file=runs/data-frozen/dataset-v1-shared-b0/validation/genis_qwen.jsonl
output_dir=runs/baselines/shared-b0-qwen-seed42-200/evaluation-genis-batch16-v1
