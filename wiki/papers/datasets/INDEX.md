...
- **[[2026-Haque-LAMDA-Android恶意软件长期漂移基准|LAMDA：Android 恶意软件长期概念漂移基准]]** — ICLR 2026 原论文与源期预处理审计；数据规模、时间协议、持续学习和未来协变量边界见配套全文笔记。
- **[[2026-Haque-LAMDA-ICLR2026官方演示版|LAMDA ICLR 2026 官方演示版]]** — 17 页官方会议演示制品，独立核对年度规模、80/20 切分、4561 维基线和 IID/NEAR/FAR 展示协议；不替代论文全文。
