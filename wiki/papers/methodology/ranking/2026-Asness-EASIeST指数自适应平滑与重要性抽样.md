...
- 官方链接：<https://arxiv.org/abs/2606.11515>；Web 检索确认作者受劳伦斯利弗莫尔国家实验室（LLNL，美国能源部下属）资助（Contract DE-AC52-07NA27344，LLNL-JRNL 编号），论文标注"Submitted to the editors"，即已投稿期刊但**尚未正式发表**（截至笔记撰写时点仅为预印本，未见期刊名称）。
