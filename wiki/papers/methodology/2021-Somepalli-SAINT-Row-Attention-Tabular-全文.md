---
title: "2021-Somepalli-SAINT-Row-Attention-Tabular"
date: 2026-09-03
tags:
  - 类型/全文转换
  - "methodology"
...
![](images/f307b7443eddfa6c1cd7de46e4ba137bc0745d64b0685cb4f0dd0260ac22fc22.jpg)  
(a)  
...
$$
\mathbf {z} _ {\mathbf {i}} ^ {(1)} = \mathrm{LN} (\mathrm{MSA} (\mathbf {E} (\mathbf {x} _ {\mathbf {i}}))) + \mathbf {E} (\mathbf {x} _ {\mathbf {i}})
$$

$$
\mathbf {z} _ {\mathbf {i}} ^ {(2)} = \mathrm{LN} (\mathrm{FF} _ {1} (\mathbf {z} _ {\mathbf {i}} ^ {(1)})) + \mathbf {z} _ {\mathbf {i}} ^ {(1)}\tag{1}
$$

$$
\mathbf {z} _ {\mathbf {i}} ^ {(3)} = \mathrm{LN} (\mathrm{MISA} (\{\mathbf {z} _ {\mathbf {i}} ^ {(2)} \} _ {i = 1} ^ {b})) + \mathbf {z} _ {\mathbf {i}} ^ {(2)}
$$

$$
\mathbf {r _ {i}} = \mathrm{LN} (\mathrm{FF} _ {2} (\mathbf {z _ {i} ^ {(3)}})) + \mathbf {z _ {i} ^ {(3)}}\tag{2}
$$
...
![](images/382b3cb55c162434d42cd635007f75b43b91423b5de0ebf8ff9dfacb10480042.jpg)  
...
$$
\mathbf {x} _ {\mathbf {i}} ^ {\prime} = \mathbf {x} _ {\mathbf {i}} \odot \mathbf {m} + \mathbf {x} _ {\mathbf {a}} \odot (\mathbf {1} - \mathbf {m})
$$

$$
\text { CutMix   in   raw   data   space }\tag{3}
$$

$$
\mathbf {p} _ {\mathbf {i}} ^ {\prime} = \alpha * \mathbf {E} (\mathbf {x} _ {\mathbf {i}} ^ {\prime}) + (1 - \alpha) * \mathbf {E} (\mathbf {x} _ {\mathbf {b}} ^ {\prime})
$$

$$
\mathrm{mixup~in~embedding~space}\tag{4}
$$
...
Loss functions We consider two losses for the pre-training phase. (i) The first is a contrastive loss that pushes the latent representations of two views of the same data point $( z _ { i }$ and $z _ { i } ^ { \prime } )$ close together and encourages different points $( z _ { i } \ \mathrm { a n d } \ z _ { j } , i \neq j )$ to lie far apart. For this, we borrow the InfoNCE loss from metric-learning works $[ 5 , 3 0 , { \dot { 3 } } 6 , 4 6 ] ; ( { \mathrm { i i } } )$ The second loss comes from a denoising task. For denoising, we try to predict the original data sample from a noisy view. Formally, we are given $\mathbf { r _ { i } ^ { \prime } }$ and we reconstruct the inputs as $\mathbf { x _ { i } ^ { \prime \prime } }$ to minimize the difference between the original and the reconstruction.The combined pre-training loss is:

$$
\mathcal {L} _ {\text { pre - training }} = \underbrace {- \sum_ {i = 1} ^ {m} \log \frac {\exp (z _ {i} \cdot z _ {i} ^ {\prime} / \tau)}{\sum_ {k = 1} ^ {m} \exp (z _ {i} \cdot z _ {k} ^ {\prime} / \tau)}} _ {\text { Contrastive   Loss }} + \lambda_ {\text { pt }} \underbrace {\sum_ {i = 1} ^ {m} \sum_ {j = 1} ^ {n} [ \mathcal {L} _ {j} (\text { MLP } _ {j} (\mathbf {r} _ {\mathbf {i}} ^ {\prime}) , \mathbf {x} _ {\mathbf {i}}) ]} _ {\text { Denoising   Loss }}\tag{5}
$$
...
<table><tr><td>Model</td><td>Attention</td><td>L</td><td>h</td><td>Param ×1e6</td><td>Time (s)</td></tr><tr><td>SAINT-s</td><td>Self</td><td>6</td><td>8</td><td>91.6</td><td>1759</td></tr><tr><td>SAINT-i</td><td>InterSample</td><td>1</td><td>8</td><td>352.7</td><td>123</td></tr><tr><td>SAINT</td><td>Both</td><td>1</td><td>8</td><td>347.3</td><td>144</td></tr></table>

able from either UCI<sup>1</sup> or AutoML.<sup>2</sup> Details of these datasets can be found in Appendix B. As the pre-processing step for each dataset, all the continuous features are Z-normalized, and all categorical features are label-encoded before the data is passed on to the embedding layer.
...
<table><tr><td>Model \ # Labeled</td><td>50</td><td>200</td><td>500</td><td>All</td></tr><tr><td>Logistic Reg.</td><td>78.69</td><td>78.93</td><td>82.13</td><td>89.25</td></tr><tr><td>Random Forest</td><td>80.99</td><td>82.56</td><td>86.76</td><td>89.52</td></tr><tr><td>XGBoost [4]</td><td>78.13</td><td>83.89</td><td>86.20</td><td>91.06</td></tr><tr><td>LightGBM [22]</td><td>78.69</td><td>85.60</td><td>87.94</td><td>90.13</td></tr><tr><td>CatBoost [10]</td><td>84.08</td><td>88.08</td><td>88.84</td><td>90.73</td></tr><tr><td>MLP w. DAE [43]</td><td>71.59</td><td>78.84</td><td>81.98</td><td>84.59</td></tr><tr><td>VIME [49]</td><td>67.22</td><td>74.43</td><td>76.24</td><td>76.07</td></tr><tr><td>TabNet w. MLM [1]</td><td>67.31</td><td>71.72</td><td>76.01</td><td>83.88</td></tr><tr><td>TabTransf. w. RTD [18]</td><td>82.41</td><td>86.16</td><td>87.36</td><td>90.86</td></tr><tr><td>SAINT-s</td><td>85.14</td><td>87.32</td><td>88.89</td><td>92.59</td></tr><tr><td>SAINT-i</td><td>83.93</td><td>84.65</td><td>88.12</td><td>93.09</td></tr><tr><td>SAINT</td><td>85.78</td><td>87.66</td><td>89.12</td><td>93.13</td></tr><tr><td>SAINT-s + pre-training</td><td>85.92</td><td>87.94</td><td>89.19</td><td>92.64</td></tr><tr><td>SAINT-i + pre-training</td><td>84.88</td><td>88.41</td><td>88.77</td><td>93.02</td></tr><tr><td>SAINT+ pre-training</td><td>86.91</td><td>88.69</td><td>89.22</td><td>92.99</td></tr></table>
...
![](images/741a3b8ecb98123d95ab58c4c67e258cf13d38be419c00c179b4bdeaa7b10d8b.jpg)  
(a) Self-attn. in SAINT

![](images/c41ab7f45143eaa2d43e3ff8baa7a791a4778a011d7f820b38829e0ff89fd99a.jpg)  
(b) Intersample attn. in SAINT

![](images/6c7bbb880f0fd096372fed9647e72d9e0e635eb05e05d5893c0297488caaeddc.jpg)  
(c) Intersample attn. in SAINT-i  
Figure 3: Visual representations of various attention mechanisms.

![](images/17b0bb93e44200509517307b0969daea906cf4965271240a60c021a2bdba424a.jpg)

![](images/99cda08e2f8dadfb852002e46898b6c5dbafabdffdc85d0d2e2458f779112c4c.jpg)  
...
[1] Sercan O Arik and Tomas Pfister. Tabnet: Attentive interpretable tabular learning. arXiv preprint arXiv:1908.07442
...
[14] Kaiming He, Xiangyu Zhang, Shaoqing Ren, and Jian Sun. Deep residual learning for image recognition. In Proceedings ofthe IEEE conference on computer vision and pattern recognition, pages 770–778, 2016.
...
[24] Yann LeCun, Léon Bottou, Yoshua Bengio, and Patrick Haffner. Gradient-based learning applied to document recognition. Proceedings ofthe IEEE, 86(11):2278–2324, 1998.
...
[38] J Stolfo, Wei Fan, Wenke Lee, Andreas Prodromidis, and Philip K Chan. Cost-based modeling and evaluation for data mining with application to fraud and intrusion detection. Resultsfrom the JAM Project by Salvatore, pages 1–15, 2000.
...
[42] Petar Velickoviˇ c, Guillem Cucurull, Arantxa Casanova, Adriana Romero, Pietro Lio, and Yoshua Bengio.´ Graph attention networks. arXiv preprint arXiv:1710.10903, 2017.
...
[47] Zichao Yang, Diyi Yang, Chris Dyer, Xiaodong He, Alex Smola, and Eduard Hovy. Hierarchical attention networks for document classification. In Proceedings ofthe 2016 conference ofthe North American chapter ofthe associationfor computational linguistics: human language technologies, pages 1480–1489, 2016.
...
[50] Sangdoo Yun, Dongyoon Han, Seong Joon Oh, Sanghyuk Chun, Junsuk Choe, and Youngjoon Yoo. Cutmix: Regularization strategy to train strong classifiers with localizable features. In Proceedings ofthe IEEE/CVF International Conference on Computer Vision, pages 6023–6032, 2019.
...
![](images/53006d89187cba4074c1529aeb7f5d0c2756947ba993fe7a32f9d60c432fdc9f.jpg)  
Figure 5: An illustration of self-attention in a point x<sub>i</sub>. Inspired by Vaswani et al [41].
...
<table><tr><td>Study</td><td>Variation</td><td>SAINT-s</td><td>SAINT-i</td><td>SAINT</td></tr><tr><td rowspan="3">1</td><td>no proj. head</td><td>84.26</td><td>83.56</td><td>84.90</td></tr><tr><td>weight sharing head</td><td>85.31</td><td>85.20</td><td>86.89</td></tr><tr><td>w. diff proj. head</td><td>86.02</td><td>85.26</td><td>86.96</td></tr><tr><td rowspan="5">2</td><td>no pre-training</td><td>85.14</td><td>83.93</td><td>85.78</td></tr><tr><td>contrastive</td><td>85.40</td><td>84.42</td><td>85.58</td></tr><tr><td>denoising</td><td>84.74</td><td>84.93</td><td>86.21</td></tr><tr><td>cosine similarity</td><td>85.03</td><td>84.35</td><td>85.70</td></tr><tr><td>contra. + denois.</td><td>86.02</td><td>85.26</td><td>86.96</td></tr><tr><td rowspan="3">3</td><td>CutMix</td><td>82.80</td><td>84.61</td><td>85.37</td></tr><tr><td>mixup</td><td>86.01</td><td>84.41</td><td>86.45</td></tr><tr><td>CutMix + mixup</td><td>86.02</td><td>85.26</td><td>86.96</td></tr></table>
...
![](images/4cd4af972db9c30de036e8e9a8fea88693a78c21a4801b29bac80f9d6db5bd1b.jpg)  
(a) Trendlines of mean AUROC of SAINT’s variants with varying % of missing data.

![](images/23cf6afbc16d94b45e75938ad5367a9ec64b69028694dde6d797bb820008fb81.jpg)  
...
![](images/52f567c1d569da0559a3269616c7a9d6c7fac4922a4028e772f41c4e4c14660f.jpg)

![](images/f754d761ce93c37e1ac5da98973ec4aaaa5105591e363671603749f6e346f0a2.jpg)

![](images/8874bd722f96c3b21d179d1644e54c26496faba1e547c248ad2cc0a9719c3a6c.jpg)

![](images/a0e3d26253b3ab14c998562c2a004510a9ee933328d7f83e7384ec9a7d23e608.jpg)

![](images/22521c6c8f125a1e14b699c01f976eea87891a77beb61a6b5ff60dff8da1eee0.jpg)  
...
![](images/f585573aa6ccaae4c79e48737031618609be8a837107f613de5fee7d9f0ecb72.jpg)

![](images/16e4aa6e1a6a4016096dca0ff85c151f7ed3c9ea1cd4fa58d4e12d9b4622de71.jpg)

![](images/37feca68d9408f8675d4891080fab184908ec7df1fef7657426dc63d56a3e81b.jpg)  
...
![](images/c241b0b3ca2500f64d87efc9c54b483413fef4ef8e0f677e37564173bccac803.jpg)

(a) Self-attn. in 1 layered SAINTs on MNIST dataset  
![](images/1337192d043c78f5b1f0d653f53459fb2a870a9e0a2e01b9cbb42bbebc4d078a.jpg)  
(b) Intersample attn. in SAINT in Volkert dataset

![](images/650351bc754ad0b2ff3bcbf309942ac5e77d7147022a433b1087b77c4ad43d6f.jpg)  
...
![](images/f44831061908e14ce76603ef6eec7b6fa7cf7549fdc08ad117b4a61a13bd2cd6.jpg)

![](images/2d77c38a924f4b2a2d5293c38b433c160f0bb8a3690fd9552360a94f98010e03.jpg)  
