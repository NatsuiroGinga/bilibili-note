...
| 方向          | 论文                                                                                               |
| ------------- | -------------------------------------------------------------------------------------------------- |
| DeepSeek 架构 | **[[mHC]]** — Birkhoff 双随机约束稳定多流残差，3B/9B/27B 预训练验证，`n=4` 时训练时间开销约 6.7%   |
...
| 数据集与证据  | **[[papers/datasets/INDEX\|数据集论文索引]]** — 原始论文、字段口径、版本、分组与泄漏风险           |
| 恶意软件漂移  | **[[papers/malware/INDEX\|恶意软件时间漂移文献索引]]** — LAMDA 原论文、直接近邻、协议风险与研究空白 |
| PINN 基础     | **[[papers/pinn/INDEX\|PINN 主题索引]]** — 原始方法、综述、扩展路线及恶意流量迁移边界              |
...
| GRPO 家族原文 | **[[papers/grpo/INDEX\|GRPO 家族原文索引]]** — GRPO／DAPO／Dr. GRPO／GSPO 四篇原文全文笔记（机制公式与页码锚点） |
...
| #PINN     | 20 个知识条目（PINN 主题 MOC 收录 13 项，另有攻击检测关联笔记 7 项）     |
