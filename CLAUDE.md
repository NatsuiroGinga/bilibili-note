...
- 本工作树当前默认论文主线为 LAMDA；`RESEARCH_ROUTE=LAMDA` 时依次读取 `.Codex/docs/LAMDA/AGENTS.md`、`LAMDA路线总控.md`、LAMDA 原始 PDF、结构化全文笔记、LAMDA 领域综述、朱焱雷第三章构思分析和 `LAMDA第三章恢复卡.md`。DRIFT、RWKV 与 PINN 不属于本工作树，不在此恢复；需要时回对应独立工作树。
